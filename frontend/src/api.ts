...
let mockApplications: HostedApplication[] = [{ id: 'mock-app-1', ownerUserId: 'mock-admin', name: '演示站点', slug: 'demo-site', repositoryUrl: 'https://gitlab.local/platform/demo-site.git', gitRef: 'main', buildMode: 'static', outputDirectory: 'dist', buildEnvironment: {}, runtimeProfile: 'non_root', containerPort: 8080, healthPath: '/', healthScheme: 'HTTP', serviceScheme: 'HTTP', clusterId: 'mock-cluster', namespace: 'default', replicas: 1, cpuRequest: '100m', memoryRequest: '128Mi', cpuLimit: '500m', memoryLimit: '512Mi', routeHost: 'apps.kust.local', routePath: '/apps/demo-site', gatewayName: 'public-gateway', gatewayNamespace: 'gateway-system', autoDeploy: true, webhookConfigured: true, createdAt: mockNow, updatedAt: mockNow, latestBuild: mockHostingBuild }];
